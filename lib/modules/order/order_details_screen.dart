    ...
    return Scaffold(
      appBar: OrderAppBar(
        ...
        title: orderItemResponse == null
            ? ""
            : "Order #${orderNumberToString(
            orderItemResponse!.orderId.toString())}",
      ),
      ...
      body: loading
        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Center(
                      child: Text(
                        "Order# ${orderNumberToString(orderItemResponse!.orderId
                            .toString())}",
              ...
              child: Card(
                ...
                child: Container(
                  ...
                  child: orderItemResponse!.paymentRequested != true
                    ...
                    children: [
                      Text(
                        "The delivery agent is requesting payment. Please pay ${orderItemResponse!
                            .totalPrice! + orderItemResponse!
                            .deliveryCharge!} taka to the number below.",
                  ...
                  Expanded(
                    child: Card(
                      ...
                      child: Padding(
                        ...
                        child: Center(
                          child: Text(
                            "Total : ${orderItemResponse!
                                .totalPrice} + ${orderItemResponse!
                                .deliveryCharge} =  ${orderItemResponse!
                                .totalPrice! +
            ...
            orderItemResponse!.orderStatus == "CANCELLED" &&
                orderItemResponse!.cancelledOrderReasonFromAdmin !=
                    null
                ? Card(
              elevation: 1,
              shape: RoundedRectangleBorder(
              ...
              child: Padding(
                ...
                child: Center(
                  child: Text(
                    "Cancellation Reason : ${orderItemResponse!
                        .cancelledOrderReasonFromAdmin}",
