...
class _OrderScreenState extends State<OrderScreen> {
  ...
  void placeOrder() async {
    ...
    showToast(context, "Placing order...");
    setState(() {
      loading = true;
    });
    ...
    hashMap["shopNames"] = cartItemsList.map((e) => e.productItemShopName).toList();
    hashMap["productsAmount"] = cartItemsList.map((e) => e.productItemAmount).toList();
    ...
    hashMap["payment"] = _paymentMethod == PaymentMethod.bKash ? "bKash" : "COD";
